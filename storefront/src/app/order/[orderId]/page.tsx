  ...
  return (
    <div className="shell max-w-4xl py-10">
      ...
      <section className="mt-8 rounded-lg border border-line bg-surface p-5">
        ...
        <a
          href={`/api/proforma/${order.id}`}
          className="mt-4 inline-flex items-center gap-2 rounded-md border border-brand px-4 py-2 text-sm font-medium text-brand transition-colors hover:bg-brand-soft"
        >
          <svg
            aria-hidden="true"
            viewBox="0 0 24 24"
